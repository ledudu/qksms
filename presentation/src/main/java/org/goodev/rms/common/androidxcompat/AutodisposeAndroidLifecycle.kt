 ...
 */
package org.goodev.rms.common.androidxcompat
...
@CheckReturnValue
inline fun LifecycleOwner.scope(): LifecycleScopeProvider<*> = org.goodev.rms.common.androidxcompat.AndroidLifecycleScopeProvider.from(this)
...
inline fun LifecycleOwner.scope(untilEvent: Lifecycle.Event): LifecycleScopeProvider<*> =
        org.goodev.rms.common.androidxcompat.AndroidLifecycleScopeProvider.from(this, untilEvent)
...
inline fun LifecycleOwner.scope(boundaryResolver: Function<Event, Event>): LifecycleScopeProvider<*> =
        org.goodev.rms.common.androidxcompat.AndroidLifecycleScopeProvider.from(this, boundaryResolver)
...
@Suppress("NOTHING_TO_INLINE")
@CheckReturnValue
inline fun Lifecycle.scope(): LifecycleScopeProvider<*> = org.goodev.rms.common.androidxcompat.AndroidLifecycleScopeProvider.from(this)
