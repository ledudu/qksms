...
import org.goodev.rms.common.util.MessageDetailsFormatter
import org.goodev.rms.common.util.extensions.makeToast
import org.goodev.rms.compat.SubscriptionManagerCompat
import org.goodev.rms.compat.TelephonyCompat
import org.goodev.rms.extensions.asObservable
import org.goodev.rms.extensions.isImage
import org.goodev.rms.extensions.mapNotNull
import org.goodev.rms.extensions.removeAccents
import org.goodev.rms.filter.ContactFilter
import org.goodev.rms.interactor.*
import org.goodev.rms.manager.ActiveConversationManager
import org.goodev.rms.manager.PermissionManager
import org.goodev.rms.model.*
import org.goodev.rms.repository.ContactRepository
                    ...
                    when {
                        ...
                        // Send a message to multiple addresses
                            ...
                            addresses.forEach { addr ->
                                val threadId = tryOrNull(false) { TelephonyCompat.getOrCreateThreadId(context, addr) }
                                        ?: 0
