 ...
 * Created on 2019/5/5.
 */
class BlockedNumberSettingsViewModel  @Inject constructor(
    ...
    init {
        val stringSet = prefs.getStringSet("block_numbers", emptySet())!!
    ...
    private fun saveKeyword(keyword: String) {
        val set = prefs.getStringSet("block_numbers", emptySet())!!
        val newSet = mutableSetOf<String>()
        newSet.addAll(set)
        newSet.add(keyword)
        prefs.edit().putStringSet("block_numbers", newSet).apply()
