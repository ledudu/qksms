 ...
 * Created on 2019/5/5.
 */
class BlockedNumberSettingsActivity : QkThemedActivity(), BlockedSettingsView {
    @Inject
    ...
    private val viewModel by lazy { ViewModelProviders.of(this, viewModelFactory)[BlockedNumberSettingsViewModel::class.java] }

    override fun onCreate(savedInstanceState: Bundle?) {
        AndroidInjection.inject(this)
        super.onCreate(savedInstanceState)
        setContentView(R.layout.blocked_number_settings_activity)
        setTitle(R.string.settings_blocking_num_title)
        showBackButton(true)
